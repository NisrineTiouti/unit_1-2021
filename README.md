...
| Unit Testing    | Y and N Input validation                                                        | So are you ready (Username) ?                                                                                                 | hihi                | Wrong input. Enter Y for Yes and N for No                                                                                                                                                | SUCCESSFUL |
| Unit Testing    | The damage function of the game                                                 | Choose a door..                                                                                                               | A wrong door choice | WRONG DOOR!!<br>You have been damaged mildly, you will have 10 seconds to recover. <br>recovering... <br>You are ready to play again <br>Remember even if trees are odd they carry fruit. | SUCCESSFUL |
| Unit Testing    | The dragon_collect Function                                                     | (Depending on which door is chosen)                                                                                           | e.g: door2          | RIGHT CHOICE!!<br>You have collected the luck dragon, Falkor. <br>10 points was added to your score.                                                                                     | SUCCESSFUL |
| Unit Testing    | The room function, room name is hollow (door3)                                  | Even is your friend, odd is your enemy. But if it carries leaves it can be your greatest win.<br>Choose a door (door3, door4): | door3               | RIGHT CHOICE!!<br>You have collected the creator of all dragons, Asgorath the greatest.<br>200 points was added to your score.<br>You are the hollow<br>Choose a door (door5, door6):      | SUCCESSFUL |
